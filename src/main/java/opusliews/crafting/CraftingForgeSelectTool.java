...
public class CraftingForgeSelectTool extends SelectTileGameTool {
	...
	public boolean inputEvent(InputEvent event) {
		...
		return event.getID() == -100 && event.state;
	}
