...
public class DSItemRegistry {
    ...
    public static final String metalworkHammerStringID = "metalworkhammer";
    ...
    public static void registerItems() {
       ...
       ItemRegistry.registerItem("builderhat", new BuilderHatArmorItem(), 25.0F, true);
       ItemRegistry.registerItem("buildershirt", new BuilderShirtArmorItem(), 55.0F, true);
       ItemRegistry.registerItem("builderboots", new BuilderBootsArmorItem(), 10.0F, true);
       ItemRegistry.registerItem("blueprintItem", new BlueprintItem(), 18.0F, true);
       ItemRegistry.registerItem("projecteraser", new ProjectEraserItem(), 18.0F, true);
       ItemRegistry.registerItem("inspectionglass", new InspectionGlassItem(), 8.0F, true);
       ItemRegistry.registerItem("malignancegoggles", new MalignanceGogglesItem(), 26.0F, true);
       ...
       registerMaterial(nailStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL), 0.375F, "nail", "metal", "metal");
       registerMaterial(hingeStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL), 1.5F, "hinge", "metal", "metal");
       registerMaterial(spruceplankStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplank"), 0.5F, "plank", "wood", "spruce");
       registerMaterial(pineplankStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplank"), 0.5F, "plank", "wood", "pine");
       registerMaterial(palmplankStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplank"), 0.5F, "plank", "wood", "palm");
       registerMaterial(birchplankStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplank"), 0.5F, "plank", "wood", "birch");
       registerMaterial(willowplankStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplank"), 0.5F, "plank", "wood", "willow");
       registerMaterial(mapleplankStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplank"), 0.5F, "plank", "wood", "maple");
       registerMaterial(deadwoodplankStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplank"), 0.5F, "plank", "wood", "deadwood");
       registerMaterial(bambooplankStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplank"), 0.5F, "plank", "wood", "bamboo");
       registerMaterial(dryadplankStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplank"), 0.5F, "plank", "wood", "dryad");
       registerMaterial(woodenshaftStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshaft"), 0.25F, "shaft", "wood", "wooden");
       registerMaterial(coppershaftStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshaft", "dsanymetalshaft"), 2.0F, "shaft", "metal", "copper");
       registerMaterial(ironshaftStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshaft", "dsanymetalshaft"), 3.0F, "shaft", "metal", "iron");
       ...
       registerMaterial(glacialshaftStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshaft", "dsanymetalshaft"), 10.0F, "shaft", "metal", "glacial");
       registerMaterial(dryadshaftStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshaft"), 0.25F, "shaft", "wood", "dryad");
       registerMaterial(myceliumshaftStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshaft"), 10.0F, "shaft", "organic", "mycelium");
       ...
       registerMaterial(tungstenplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate", "dsanymetalplate"), 40.0F, "plate", "metal", "tungsten");
       registerMaterial(demonicplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate", "dsanymetalplate"), 20.0F, "plate", "metal", "demonic");
       registerMaterial(ivyplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate"), 24.0F, "plate", "organic", "ivy");
       registerMaterial(quartzplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate"), 30.0F, "plate", "gem", "quartz");
       registerMaterial(slimeplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate"), 30.0F, "plate", "organic", "slime");
       registerMaterial(glacialplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate", "dsanymetalplate"), 40.0F, "plate", "metal", "glacial");
       registerMaterial(dryadplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate"), 1.0F, "plate", "wood", "dryad");
       registerMaterial(myceliumplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate"), 40.0F, "plate", "organic", "mycelium");
       registerMaterial(runicplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate"), 40.0F, "plate", "magic", "runic");
       registerMaterial(spideriteplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate", "dsanymetalplate"), 56.0F, "plate", "metal", "spiderite");
       registerMaterial(nightsteelplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate", "dsanymetalplate"), 48.0F, "plate", "metal", "nightsteel");
       registerMaterial(ancientfossilplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate", "dsanymetalplate"), 40.0F, "plate", "metal", "ancientfossil");
       registerMaterial(arcanicplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate"), 50.0F, "plate", "magic", "arcanic");
       registerMaterial(crystalplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate"), 50.0F, "plate", "gem", "crystal");
       registerMaterial(emeraldplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate"), 70.0F, "plate", "gem", "emerald");
       registerMaterial(rubyplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate"), 70.0F, "plate", "gem", "ruby");
       registerMaterial(amethystplateStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyplate"), 70.0F, "plate", "gem", "amethyst");
       ...
       registerMaterial(tungstenbladeStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyblade", "dsanymetalblade"), 240.0F, "blade", "metal", "tungsten");
       registerMaterial(demonicbladeStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyblade", "dsanymetalblade"), 120.0F, "blade", "metal", "demonic");
       registerMaterial(ivybladeStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyblade"), 144.0F, "blade", "organic", "ivy");
       registerMaterial(quartzbladeStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyblade"), 300.0F, "blade", "gem", "quartz");
       registerMaterial(glacialbladeStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyblade", "dsanymetalblade"), 400.0F, "blade", "metal", "glacial");
       registerMaterial(slimebladeStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyblade"), 30.0F, "blade", "organic", "slime");
       registerMaterial(amethystbladeStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyblade"), 375.0F, "blade", "gem", "amethyst");

       // Molded tool components
       registerMaterial(copperPickaxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanypickaxehead"), 32.0F, "pickaxehead", "metal", "copper");
       registerMaterial(copperAxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyaxehead"), 32.0F, "axehead", "metal", "copper");
       registerMaterial(copperShovelHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshovelhead"), 32.0F, "shovelhead", "metal", "copper");
       registerMaterial(ironPickaxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanypickaxehead"), 48.0F, "pickaxehead", "metal", "iron");
       registerMaterial(ironAxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyaxehead"), 48.0F, "axehead", "metal", "iron");
       registerMaterial(ironShovelHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshovelhead"), 48.0F, "shovelhead", "metal", "iron");
       registerMaterial(goldPickaxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanypickaxehead"), 80.0F, "pickaxehead", "metal", "gold");
       registerMaterial(goldAxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyaxehead"), 80.0F, "axehead", "metal", "gold");
       registerMaterial(goldShovelHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshovelhead"), 80.0F, "shovelhead", "metal", "gold");
       registerMaterial(frostPickaxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanypickaxehead"), 100.0F, "pickaxehead", "magic", "frost");
       registerMaterial(frostAxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyaxehead"), 100.0F, "axehead", "magic", "frost");
       registerMaterial(frostShovelHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshovelhead"), 100.0F, "shovelhead", "magic", "frost");
       registerMaterial(demonicPickaxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanypickaxehead"), 100.0F, "pickaxehead", "metal", "demonic");
       registerMaterial(demonicAxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyaxehead"), 100.0F, "axehead", "metal", "demonic");
       registerMaterial(demonicShovelHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshovelhead"), 100.0F, "shovelhead", "metal", "demonic");
       registerMaterial(runicPickaxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanypickaxehead"), 100.0F, "pickaxehead", "magic", "runic");
       registerMaterial(runicAxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyaxehead"), 100.0F, "axehead", "magic", "runic");
       registerMaterial(runicShovelHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshovelhead"), 100.0F, "shovelhead", "magic", "runic");
       registerMaterial(ivyPickaxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanypickaxehead"), 120.0F, "pickaxehead", "organic", "ivy");
       registerMaterial(ivyAxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyaxehead"), 120.0F, "axehead", "organic", "ivy");
       registerMaterial(ivyShovelHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshovelhead"), 120.0F, "shovelhead", "organic", "ivy");
       registerMaterial(quartzPickaxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanypickaxehead"), 150.0F, "pickaxehead", "gem", "quartz");
       registerMaterial(quartzAxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyaxehead"), 150.0F, "axehead", "gem", "quartz");
       registerMaterial(quartzShovelHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshovelhead"), 150.0F, "shovelhead", "gem", "quartz");
       registerMaterial(tungstenPickaxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanypickaxehead"), 320.0F, "pickaxehead", "metal", "tungsten");
       registerMaterial(tungstenAxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyaxehead"), 320.0F, "axehead", "metal", "tungsten");
       registerMaterial(tungstenShovelHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshovelhead"), 320.0F, "shovelhead", "metal", "tungsten");
       registerMaterial(glacialPickaxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanypickaxehead"), 320.0F, "pickaxehead", "metal", "glacial");
       registerMaterial(glacialAxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyaxehead"), 320.0F, "axehead", "metal", "glacial");
       registerMaterial(glacialShovelHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshovelhead"), 320.0F, "shovelhead", "metal", "glacial");
       registerMaterial(dryadPickaxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanypickaxehead"), 260.0F, "pickaxehead", "wood", "dryad");
       registerMaterial(dryadAxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyaxehead"), 260.0F, "axehead", "wood", "dryad");
       registerMaterial(dryadShovelHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshovelhead"), 260.0F, "shovelhead", "wood", "dryad");
       registerMaterial(myceliumPickaxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanypickaxehead"), 320.0F, "pickaxehead", "organic", "mycelium");
       registerMaterial(myceliumAxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyaxehead"), 320.0F, "axehead", "organic", "mycelium");
       registerMaterial(myceliumShovelHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshovelhead"), 320.0F, "shovelhead", "organic", "mycelium");
       registerMaterial(ancientfossilPickaxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanypickaxehead"), 320.0F, "pickaxehead", "metal", "ancientfossil");
       registerMaterial(ancientfossilAxeHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyaxehead"), 320.0F, "axehead", "metal", "ancientfossil");
       registerMaterial(ancientfossilShovelHeadStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL, "dsanyshovelhead"), 320.0F, "shovelhead", "metal", "ancientfossil");
       ...
       registerMaterial(magicfocusStringID, new CraftingMaterialItem(500, Item.Rarity.NORMAL), 15.0F, "focus", "magic", "magic");
